...
id: llm-service
title: LLM Service
description: "Language model service providing social analytics and performance reporting capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for social analytics and performance reporting. Used by all skills in this skrpt.
